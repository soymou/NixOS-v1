...
let
  ...
  pkgs = import inputs.hydenix.inputs.hydenix-nixpkgs {
    ...
    overlays = [
      ...
      (final: prev: {
	nvchad = inputs.nix4nvchad.packages."${inputs.hydenix.lib.system}".nvchad;
...
in
{
  ...
  hydenix = {
    ...
    locale = "es_MX.UTF-8"; # Change to your preferred locale
  ...
  users.users.mou = {
    ...
    extraGroups = [
      ...
      "wireshark" # For wireshark access
      "nordvpn" # For nordvpn access
    ];
